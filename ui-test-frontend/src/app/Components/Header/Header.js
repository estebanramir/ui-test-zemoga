...
export const Header = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try{
                const response = await fetch('http://localhost:3001/data/actual');
    ...
    <nav class="nav" role="navigation">
        <div class="max-centered">
            ...
            <ul class="nav__links">
                <li>
                    <Link href="/past-trials">Past Trials</Link>
                </li>
                <li>
    ...
    <header class="hero">
        ...
        <div class="max-centered">
            <div class="hero__featured-card">
                ...
                <div class="featured-card__content">
                    ...
                    <h2 class="featured-card__title">{info.name}</h2>
                    <p class="featured-card__desc">
                        {info.description}
                    </p>
                    <p class="featured-card__more-info">
                        <a href="https://es.wikipedia.org/wiki/Francisco_(papa)">
        ...
        <div class="hero__closing-gauge">
            ...
            <div class="closing-gauge__right">
                <span class="closing-gauge__number">{info.daysRemaining}</span>
